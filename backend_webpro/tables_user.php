              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
               ...
               <tfoot>
                ...
                <tr>
                        ...
                        <td><?= $row["password"]; ?></td>
                        <td><?= $row["role"]; ?></td> 
                        <td><?=date('d-m-Y H:m:s', strtotime($row['date_created']))?></td>
                        <td><?=date('d-m-Y H:m:s', strtotime($row['date_modified']))?></td>
                        
                    <?php echo
                  "<td>
                      <a href='update_user.php?email=$row[email]'>Edit</a> |
                        <a href='delete_user.php?email=$row[email]' onClick=\"return confirm('Anda yakin akan menghapus record ini?')\">Delete</a>
                  </td>";
