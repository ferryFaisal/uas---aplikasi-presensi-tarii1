      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <h3>
              <a href="form_mahasiswa.php">Add Mahasiswa</a>
            </h3>
    ...
    $result = $conn->query($sql);
      ...
      ?>
            ...
            <tr>
              ...
              <?php echo
                  "<td>
                      <a href='update_mahasiswa.php?nim=$row[nim]'>Edit</a> |
                        <a href='delete_mahasiswa.php?nim=$row[nim]' onClick=\"return confirm('Anda yakin akan menghapus record ini?')\">Delete</a>
                  </td>";
