      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <!-- <h3>
              <a href="form_customers.php">Add Customers</a>
            </h3> -->
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr>
                        ...
                        <td><?= $row["nim"]; ?></td>
                        <td><?= $row["nama"]; ?></td> 
                        <td><?=date('d-m-Y H:m:s', strtotime($row['tgl_presensi']))?></td>
                        
                        <!-- <?php echo
                  "<td>
                        <a href='delete_presensi.php?tgl_presensi=$row[tgl_presensi]' onClick=\"return confirm('Anda yakin akan menghapus record ini?')\">Delete</a>
                  </td>";
